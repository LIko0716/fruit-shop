...
<div class="width1198 center_yh" style="height: 35px;background: #f0f0f0; border: 1px solid #ddd;margin-top:25px;">
    <a href="item/shopList?category_id_two=${obj.category_id_two}&name=${obj.name == null ?"":obj.name}" class="mR">默认</a>
    <a href="item/shopList?price=1&category_id_two=${obj.category_id_two}&name=${obj.name == null ?"":obj.name}" class="mR">
        价格
        <img src="resource/user/images/gg.png" alt="">
    </a>
    <a href="item/shopList?gmNum=1&category_id_two=${obj.category_id_two}&name=${obj.name == null ?"":obj.name}" class="mR">
        销量
        <img src="resource/user/images/gg.png" alt="">
    </a>
