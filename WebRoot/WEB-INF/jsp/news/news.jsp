...
<body>
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul>
                <li>
                    <a  class="button border-main icon-plus-square-o" href="news/add">添加新闻</a>
            ...
            <c:forEach items="${pagers.datas}" var="data" varStatus="1">
                <tr>
                    ...
                    <td>
                        ...
                        <a class="button border-red" href="news/delete?id=${data.id}"><span class="icon-trash-o">下架</span></a>
                    </td>
                </tr>
            </c:forEach>
            <tr>
