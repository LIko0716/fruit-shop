...
<body>
    <div class="panel admin-panel">
        <form action="user/findBySql" id="listform">
        <div class="padding border-bottom">
            <ul>
                <li>
                    <input type="text" placeholder="请输入用户名" value="${name}" name="userName" class="input" style="width: 250px;line-height: 17px;display: inline-block">
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="itemCategory/update?id=${data.id}"><span class="icon-edit">修改</span> </a>
                            <a class="button border-red" href="itemCategory/delete?id=${data.id}"><span class="icon-trash-o">删除</span> </a>
                        </div>
                    </td>
                </tr>
            </c:forEach>
