...
<body>
    <div class="panel admin-panel">
        ...
        <div class="body-content">
            <form action="itemCategory/exAdd2" type="post" class="form-x">
                <input type="hidden" name="pid" value="${pid}">
                <div class="form-group">
                    <div class="label"><lable>一级类目名称:</lable></div>
                    <div class="field">
                        <input type="text" class="input w50" disabled="disabled" value="${name}">
                        <div class="tips"></div>
                    </div>
                    <div class="form-group">
                        <div class="label"><lable>二级类目名称:</lable></div>
                        <div class="field">
